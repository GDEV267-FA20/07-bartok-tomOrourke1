...
{                                         // b
 ...
 // this was a solution I found instead of finding the proper util method that wasn't there        //Quaternion rotQ = Quaternion.Euler(Utils.Bezier(uC, bezierPts)); // was bezierRots could it need to be bezierPts? // added Quaternion.Euler
